...
training_set = train_datagen.flow_from_directory('C:\Users\PRIYANKA MADIRE\Downloads\Plant-Leaf-Disease-Prediction-main\Dataset\train', 
                                                 target_size = (128, 128),
                                                 batch_size = 6, class_mode = 'categorical')
valid_set = test_datagen.flow_from_directory('C:\Users\PRIYANKA MADIRE\Downloads\Plant-Leaf-Disease-Prediction-main\Dataset\val', 
                                             target_size = (128, 128), 
