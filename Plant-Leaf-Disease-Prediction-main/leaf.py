...
filepath = 'C:\\Users\\PRIYANKA MADIRE\\Downloads\\Plant-Leaf-Disease-Prediction-main\\model.h5'
...
def pred_tomato_dieas(tomato_plant):
  ...
  if pred==0:
     ...
     return "Potato-powered_disease",'Potato.html'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('C:\\Users\\PRIYANKA MADIRE\\Downloads\\Plant-Leaf-Disease-Prediction-main\\static\\upload\\', filename)
        file.save(file_path)
